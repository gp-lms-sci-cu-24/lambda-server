...
public interface CourseResultRepository extends JpaRepository<CourseResult, Long> {
    ...
    Set<CourseResult> findByStudent(Student student);

    Set<CourseResult> findByStudentAndCourseClassYearAndCourseClassSemesterIn(Student student, Integer year, Set<YearSemester> semester);
}